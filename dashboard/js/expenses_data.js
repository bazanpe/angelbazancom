(function () {
  ...
  window.EXPENSES_DATA = {
    ...
    items: [
      // META ADS
      { source: 'Scotiabank Visa Oro', date: '2026-06-28', desc: 'FACEBK *XLA8ATRH52 fb.me/ads', cat: 'Marketing & Ads', type: 'Negocio', usd: 68.00, pen: 255.00, status: 'Mantener' },
      ...
      { source: 'Scotiabank Visa Oro', date: '2026-06-30', desc: 'OPENAI *CHATGPT SUBSCR OPENAI.COM', cat: 'Inteligencia Artificial', type: 'Negocio', usd: 23.60, pen: 88.50, status: 'Optimizar' },
      ...
      { source: 'Scotiabank Visa Oro', date: '2026-06-28', desc: 'SUNO INC. SUNO.COM', cat: 'Inteligencia Artificial', type: 'Negocio', usd: 10.00, pen: 37.50, status: 'Optimizar' },
      ...
      { source: 'Scotiabank Visa Oro', date: '2026-06-29', desc: 'SPROUTVIDEO LLC (Video Hosting)', cat: 'Infraestructura & SaaS', type: 'Negocio', usd: 2.00, pen: 7.50, status: 'Mantener' },
      ...
      // SKOOL & INFOPRODUCTOS
      { source: 'Scotiabank Visa Oro', date: '2026-06-27', desc: 'P.SKOOL.COM/BPJGF (Comunidad Skool 1)', cat: 'Educación & Comunidades', type: 'Negocio', usd: 17.00, pen: 63.75, status: 'Optimizar' },
      ...
      { source: 'Scotiabank Visa Oro', date: '2026-06-27', desc: 'KIWIFY*BMADarkRad Natal BR', cat: 'Educación & Comunidades', type: 'Negocio', usd: 9.39, pen: 35.21, status: 'Mantener' },
      ...
      { source: 'Scotiabank Visa Oro', date: '2026-06-27', desc: 'Google AutoResponder', cat: 'Servicios Cloud & Email', type: 'Negocio', usd: 7.86, pen: 29.48, status: 'Optimizar' },
      ...
      { source: 'Scotiabank Visa Oro', date: '2026-06-28', desc: 'EL PIOMBINO SAN MIGUEL', cat: 'Alimentación & Delivery', type: 'Personal', usd: 6.00, pen: 22.50, status: 'Personal' },
      ...
      { source: 'Scotiabank Visa Oro', date: '2026-06-30', desc: 'APPLE.COM/BILL (Suscripciones Apple)', cat: 'Entretenimiento & Ocio', type: 'Personal', usd: 12.98, pen: 48.68, status: 'Optimizar' },
      ...
      { source: 'Scotiabank Visa Oro', date: '2026-06-28', desc: 'FALABELLA SAN MIGUEL S LIMA', cat: 'Compras & Retail', type: 'Personal', usd: 63.95, pen: 239.80, status: 'Personal' },
      ...
      { source: 'Scotiabank Visa Oro', date: '2026-06-29', desc: 'APPARKA MEGAPLAZA LIMA (Estacionamiento)', cat: 'Transporte & Viajes', type: 'Personal', usd: 2.67, pen: 10.00, status: 'Personal' },
      ...
      { source: 'Scotiabank Visa Oro', date: '2026-06-29', desc: 'EBN*Canva04927 LIMA PE', cat: 'Seguridad & Utilidades', type: 'Personal', usd: 7.47, pen: 28.00, status: 'Mantener' },
